...
<div id="wrap">
    ...
    $sql_edit = "SELECT * FROM banner_left WHERE iid_banner=" . $id;
    $query_edit = mysql_query($sql_edit);
    $row = mysql_fetch_array($query_edit);
    ?>
    <!--PAGE CONTENT -->
    <div id="content">
        <form name="form" action="ads_editors.php?id=<?php echo $row['iid_banner']; ?>" method="post" enctype="multipart/form-data">
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                ...
                <img src="<?php echo $row['vpath_image_banner'] ?>" class="img-product">
                <input class="abc-form form-control animated slideInRight" value="<?php echo $row['vpath_image_banner']; ?>"
                ...
                <input class="abc-form form-control animated slideInRight" value="<?php echo $row['vlink_image_banner']; ?>"
...
if (isset($_POST['edit-save'])) {
    ...
    $sql_save="update banner_left set vpath_image_banner='".$edit_images."', vlink_image_banner='".$edit_link."' where iid_banner='".$id."'";
    ...
    echo"<script>window.location.href='ads_editors.php?id=".$id."'</script>";
}
?>
<!--END MAIN WRAPPER -->
