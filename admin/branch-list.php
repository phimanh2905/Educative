    ...
    <div id="wrap">
        ...
        <div id="content">
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="list-product"> Chi nhánh </h2>
                        <a href="add-branch.php" class="btn-success add-product">Thêm chi nhánh</a>
                    </div>
                </div>
                <hr />
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="branch-list.php" method="post">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $sql_td = mysqli_query($connect, "SELECT * FROM address_footer");
                                        ...
                                        while ($row = mysqli_fetch_array($sql_td)) {
                                            ...
                                            echo "<td><input name=chk[] class='checkk' type=checkbox value='" . $row['iid_footer'] . "'></td>";
                                            echo "<td><a href='branch_editors.php?id=" . $row['iid_footer'] . "'>Sửa</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
                                ...
                                if (isset($_POST['btn-delete'])) {
                                    if (empty($_POST['chk'])) {
                                        ...
                                        $del = mysql_query("DELETE FROM address_footer WHERE iid_footer IN ($id)");
                                        if($del) {echo 'Xoá chuyên mục thành công <script>window.location.href = window.location.pathname;</script>';}
                                            ...
                                            header("Refresh:0; url=branch-list.php");
                                        }
                                    }
                                }
                                ?>
