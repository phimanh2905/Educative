    ...
    <div id="wrap">
        ...
        <div id="content">
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="list-product"> Khách hàng phản hồi </h2>
                    </div>
                </div>
                <hr />
                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Tất cả khách hàng phản hồi
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form action="send-user-list.php" method="post">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $sql_td = mysqli_query($connect, "SELECT * FROM contact_form");
